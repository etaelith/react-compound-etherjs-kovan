...
const style = {
  ...
  input: `bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg w-1/2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white`,
}
const ReadERC20 = () => {

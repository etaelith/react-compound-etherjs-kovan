    ...
    <div className="flex items-center justify-center w-screen h-screen bg-gradient-to-r from-indigo-600 to-blue-400">
      <div className="px-40 py-20 bg-white dark:bg-gray-800 rounded-md shadow-xl">
        <div className="flex flex-col items-center">
          <h1 className="font-bold text-gray-300 dark:text-gray-600 text-7xl">Web3 need You</h1>
          <h6 className="mb-2 text-2xl font-bold text-center text-gray-800 dark:text-gray-500 md:text-3xl">
            <span className="text-red-500">Oops!</span> You can't access to page
          </h6>
